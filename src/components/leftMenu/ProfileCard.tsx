  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6">
        <div className="h-20 relative">
            ...
            <Image src={user.avatar || "/noAvatar.png"} alt="Profile" width={48} height={48} className="absolute object-cover rounded-full w-12 h-12 -bottom-6 left-0 right-0 m-auto ring-1 ring-white z-10" />
        </div>
